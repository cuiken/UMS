 ...
 */
@Namespace("/store")
@Results({ @Result(name = "reload", location = "mpb-store.action", type = "redirect") })
public class MpbStoreAction  extends ActionSupport {
...
//        logger.info(json);
    ...
    private void loopHtml(StringBuilder buffer,SpanHtml html){
        ...
        buffer.append("<a href=\\\"mpb-store!details.action?id="+html.getId()+"&"+html.getQueryString()+"\\\" class=\\\"down-area\\\"></a>");
        buffer.append("</li>");
    }
