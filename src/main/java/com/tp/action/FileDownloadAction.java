...
public class FileDownloadAction extends ActionSupport {
	...
	private String getLockerClient(String v, String app, String dtype) throws Exception {
		String version = v;
		if (StringUtils.isBlank(version)) {
			version = clientFileManager.getNewestVersionCode(dtype);
		} else if ((app != null) && !app.equals("千机解锁") && !app.equals("Funlocker")) {// 内容下客户端,兼容老版本客户端v参数值的错误
			version = clientFileManager.getNewestVersionCode(dtype);
		}
