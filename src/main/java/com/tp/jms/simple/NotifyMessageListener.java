...
import com.tp.email.SimpleMailService;
	...
	public void onMessage(Message message) {
		try {
			...
			if (simpleMailService != null) {
				simpleMailService.sendNotificationMail(mapMessage.getString("userName"),mapMessage.getString("email"));
			}
		} catch (Exception e) {
