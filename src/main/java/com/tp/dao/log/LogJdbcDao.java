...
public class LogJdbcDao {
    ...
    private static final String QUERY_HOTTEST_DOWNLOAD = "SELECT ffi.f_id,ffi.title,ffi.short_description as shortDescription ,f.apk_path,f.dtype,f.icon_path as iconPath ,f.is_hot as ishot, f.is_new as isnew FROM f_file f right join"
